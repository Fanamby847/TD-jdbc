...
public class DataRetriever {
    ...
    public List<DishIngredient> findDishIngredientsByDishId(Integer dishId) throws SQLException {
        String sql = """
        SELECT di.quantity, di.unit,
               i.id as ingredient_id, i.name, i.price, i.category
